...
| All stages | Delegate bounded work to inspectable subagents | [`subagent-orchestration`](../.agents/skills/subagent-orchestration/SKILL.md) | Approved run manifest, explicit requested configuration, runtime identities and observations, complete task dispositions, and integration evidence |
